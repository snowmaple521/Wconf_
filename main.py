...
def parse_args():
    ...
    parser.add_argument(
        '--dataset', default='cpv1',
        choices=["v2", "cpv2", "cpv1"],
        help="Run on VQA-2.0 instead of VQA-CP 2.0"
    )
    parser.add_argument( '--a', default=2.4,type=float)
    parser.add_argument(
    ...
    parser.add_argument('--output', type=str, default='logs/cpv1_updn_conf')
...
def get_bias(train_dset,eval_dset):
    ...
    print('question_type_to_count:',question_type_to_count)
    print('finish!')
